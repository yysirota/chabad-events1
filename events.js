...
function fitAllEventTitles(root){
     ...
     */
        ...
        /*
         * IMPORTANT:
         * Remove only the width/alignment that THIS routine may
         * have applied during an earlier render or resize.
         *
         * This returns every title to its normal existing layout
         * before the normal title-fitting code runs.
         */
        title.style.width="";
        ...
        /*
         * Keep the existing title sizing behavior completely intact.
         */
        fitTitleElement(
            title,
            25,
        ...
        /*
         * Measure the actual rendered text lines.
         *
         * We are NOT deciding based on character count.
         * The adjustment happens only when the browser has
         * actually wrapped this particular title onto 2 lines.
         */
        if(
        ...
        /*
         * Group text rectangles that sit on the same visual line.
         * This remains reliable even if the title later contains
         * more than one text/span fragment.
         */
         ...
         * One-line title?
         *
         * Leave it EXACTLY as it already was.
         */
        if(lines.length<2){
            return;
        }
        ...
        /*
         * Find the width of the longer rendered line.
         */
        for(
            lineIndex=0;
            lineIndex<lines.length;
        ...
        /*
         * Make the title block only as wide as its longest line.
         *
         * Because .cfle-home-event-content already begins at the
         * normal text starting point beside the date box, the
         * longest line now begins there too.
         *
         * The tiny 2px allowance prevents sub-pixel rounding from
         * unexpectedly changing the line break.
         */
        targetWidth=
            Math.min(
                availableWidth,
        ...
        /*
         * Center the shorter line INSIDE the longest-line width.
         *
         * Result:
         *
         * [DATE]  Sukkot &
         *         Simchat Torah
         *
         * The longer line starts where a normal one-line title
         * starts, while the shorter line remains visually centered.
         */
        title.style.textAlign=
            "center";
    });
